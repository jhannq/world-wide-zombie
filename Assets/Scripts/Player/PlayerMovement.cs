...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (curSpeedX > 0 && curSpeedY > 0 && isRunning == false) {
            FindObjectOfType<AudioManager>().Play("Walking");
        }

        if (curSpeedX > 0 && curSpeedY > 0 && isRunning == true) {
        ...
        {
            this.gameObject.transform.position = new Vector3(initialPosition.x, initialPosition.y+5f, initialPosition.z);
        }
